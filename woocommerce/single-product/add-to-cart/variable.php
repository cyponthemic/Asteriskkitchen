	...
	<?php if ( ! empty( $available_variations ) ) : ?>
		...
		<table class="variations" cellspacing="0">
			<tbody>
                ...
                ?>
					<tr>
						<td class="label"><label for="<?php echo sanitize_title($name); ?>">Discover our different<?php if (isset($labeltext) && ($labeltext != '')) { echo 'Discover our different '.$labeltext; } else { echo 'Discover our different '.wc_attribute_label( $name ); } ?></label></td>
						<td class="value"> <?php
